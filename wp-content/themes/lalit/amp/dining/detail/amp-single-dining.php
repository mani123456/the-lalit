...
$GLOBALS['current_theme_template'] = 'single-dining';
$destination  = get_destination_by_feature_id("dinings", get_the_id());
...
$GLOBALS['page-name'] = 'dining-details';
   ...
   <head>
    ...
    <body <?php body_class('local-page'); ?> on="tap:booking-widget-accordion.collapse" role="button" tabindex="0">
            <?php include_once(get_template_directory() . '/amp/includes/amp-header.php'); ?>
                ...
                <?php include_once(get_template_directory() . '/amp/dining/detail/amp-dining-detail.php'); ?>
