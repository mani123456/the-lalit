...
$GLOBALS['current_theme_template'] = 'location';
$page_id = get_the_ID();
...
$itemList[2]['item']['@id'] = site_url() . $_SERVER['REQUEST_URI'] . '/?amp';
...
<html amp>
   <head>
      ...
      <?php include_once(get_template_directory() . '/amp/includes/amp-css-js.php'); ?>
        ...
        <?php
          $css = file_get_contents(get_template_directory()."/stylesheets/css/amp-location.min.css");
   ...
   <body <?php body_class('local-page'); ?>>
         <?php include_once(get_template_directory() . '/amp/includes/amp-header.php'); ?>
            ...
            <?php include_once(get_template_directory() . '/amp/location/location-listing.php'); ?>
