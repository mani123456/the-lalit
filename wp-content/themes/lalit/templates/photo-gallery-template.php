...
/**
 *
  Template Name: Photo Gallery Landing Template
 *
 *
...
$itemList[2]['item']['name'] = 'Photo Gallery';
    ...
    <body <?php body_class('local-page'); ?>>
        <div class="main-wrap">
          ...
          <script type="text/javascript">
              var gallery_images = <?php echo json_encode($GLOBALS['gallery_images']); ?>;
          </script>
          <script src="<?php echo get_stylesheet_directory_uri(); ?>/js/photo-gallery.min.js" async></script>
        </div>
    </body>
</html>