<?php
    ...
    wp_reset_postdata();*/
?>
<div class="content-section media-coverage small-banner">

      <!-- slider -->
     <div class="container align-center small-banner-sec js_fade" style="background-image:url('/wp-content/themes/lalit/images/press-release.jpg')">
          <div class="row">
    ...
    <div class="container align-center no-record-found" style="display:none;">
        <div class="row  no-record">
            <h1 class="main-title text-black">Sorry! No Press Releases Available</h1>
            <div class="row ">
                <div class="col8 align-content-center">
                    <p class="disp-text">We are sorry that we have nothing to display here. Please try a different filter to access other Press Releases.</p>
    ...
    <?php
        ...
        $press_release_object = get_press_rooms('press-release','published_date');
                    ...
                    <ul class="col col8 listing-sec unstyled-listing align-content-center">
                        <?php
                            ...
                            while($press_release_object->have_posts()):
                                ...
                                $press_release_object->the_post();
                                $press_release_title = get_post_meta($post->ID,'press_release_title',true);
                                //$body_copy_press_release = get_post_meta($post->ID,'body_copy_press_release',true);
                                ...
                                if($published_date != '' && trim($press_release_title) != '' && trim($short_description) != '' && !empty($location) && !empty($year))
                                {
                                        ...
                                        <li class="<?php echo ' all-years all-destinations '.$location[0]->slug.' '.$year[0]->slug; ?>"> 
                                            <div class="row">
                                                <div class="col col9 release-list"> 
                                                    ...
                                                    <?php if(trim($press_release_title) != '') { ?><h3><a href="<?php the_permalink(); ?>" class=""><?php echo $press_release_title; ?></a></h3><?php } ?>
    ...
    <div class="container fluid-width media-contact">
        <div class="row">
            <div class="col col2 align-content-center align-center"> 
                <h3>Media Contact</h3>              
                <p> <a href="tel:+91 11 26554329">+91 11 26554329</a></p>
