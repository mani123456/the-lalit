<?php   
 ...
 if( $destination_obj->have_posts() ) : 
    while($destination_obj->have_posts()) : $destination_obj->the_post();
       ...
       $room_offers = get_offers_by_type(1, $post->ID);
...
<?php
                    ...
                    foreach($suites_and_rooms_object as $suite_and_room_id)
                    {
                        if(get_post_status ( $suite_and_room_id ) == 'publish')
                        {
                            ...
                            {    
?>
                                <div class="col col6 card-item js_fade">
...
<?php
                                            if($room_images)
                                            {
                                               ...
                                               {
                                                  $room_image = wp_get_attachment_image_src($room_image_id, 'banner_image')[0];
...
?>
                                              <li class="meta-item">
                                                ...
                                                <strong class="meta-value"><?php echo $curr; ?><?php echo number_format($room_base_price); ?></strong>
                                              </li>
<?php
                                        }
?>
