...
$we_care_post_new_post = get_we_care_new();
...
if ($we_care_post_new_post->have_posts()) :
    while ($we_care_post_new_post->have_posts()) : $we_care_post_new_post->the_post();
        // print_r($post->ID);
        ...
        if ($we_care_object) {
            ...
            if (get_post_status($post->ID) == 'publish') {
                $we_care_type_obj = get_the_terms($post->ID, 'we-care-type-new');
...
<div class="content-section">
    <?php
    $home_banners = get_page_banners_by_taxomany_all('we_care_new_list_banner');
    ?>
    ...
    <div class="room-training_course-listing">
        ...
        foreach ($types as $type) {
            ...
            $banner_hide_heading = get_field('hide_heading', $type);

            if (in_array($term_id, $we_care_type_ids) && $parent == 0) {
        ?>
                <div class="category-page-container container" data-design="<?php echo $banner_type; ?>" style="margin-top:30px;">
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12 zero-padding">
                            <!-- Sec Title -->
                            <?php if ($banner_hide_heading) { ?>
                            ...
                            <div class="row">
                                <?php if ($banner_type == 'Slider' || $banner_type == '') { ?>
                                    <div class="col-lg-12 col-md-12 col-sm-12 zero-padding">
                                                                            ...
                                                                            if ($we_care_name != ''  || $we_care_description != '') { ?>
                                                                                <div class="lower-content">
                                                                                    ...
                                                                                    <?php if ($we_care_description != '') { ?>
                                                                                        <div style="padding-bottom:12px; min-height: 100px;">
                                        ...
                                        <div class="col-lg-2 col-md-2 col-sm-2 zero-padding">
                                        </div>
                                    </div><!-- row -->
                                <?php
                                } else if ($banner_type == 'Grid-d') {
                                ?>
                                <section class="blog-section overflow-hidden section-white" id="page-section-gallery" style="background-image:none;background-color:#fff;color:#000">
   <div class="position-relative">
      <div class="row m-1">
         <div class="col-md-12 mx-auto">
            <div class="text-center padding-l-5  ">
               <h2 class="black  bold margin-b-20">We Care</h2>
            </div>
         </div>
      </div>
      <div class="row">
               ...
               <div class="">
                  <div class="">
                     <div class="list-mig-like-com">
                        <div class="list-mig-lc-img"><img src="https://admin.thelalit.com/getImageByPath.action?imgpath=/opt/thelalit_v1/touradmin/resource/website/website_gallary/gallerysliderbanner2_41.jpg" data-src="https://admin.thelalit.com/getImageByPath.action?imgpath=/opt/thelalit_v1/touradmin/resource/website/website_gallary/gallerysliderbanner2_41.jpg"></div>
         ...
         <div class="col-md-6">
            <div class="row">
               <div class="col-md-6">
                  <a href="#" data-toggle="" data-target="">
                     <div class="list-mig-like-com">
                        <div class="list-mig-lc-img"><img src="https://admin.thelalit.com/getImageByPath.action?imgpath=/opt/thelalit_v1/touradmin/resource/website/website_gallary/gallerysliderbanner13_86.jpg" data-src="https://admin.thelalit.com/getImageByPath.action?imgpath=/opt/thelalit_v1/touradmin/resource/website/website_gallary/gallerysliderbanner13_86.jpg"></div>
                     </div>
                  </a>
               </div>
               <div class="col-md-6">
                  <a href="#" data-toggle="" data-target="">
                     <div class="list-mig-like-com">
                        <div class="list-mig-lc-img"><img src="https://admin.thelalit.com/getImageByPath.action?imgpath=/opt/thelalit_v1/touradmin/resource/website/website_gallary/gallerysliderbanner12_86.jpg" data-src="https://admin.thelalit.com/getImageByPath.action?imgpath=/opt/thelalit_v1/touradmin/resource/website/website_gallary/gallerysliderbanner12_86.jpg"></div>
                        <div class="list-mig-lc-con">
                           <div class="mt-2 p-2">
                              <div class="row">
                              <h2>
               ...
               <div class="col-md-6">
                  <a href="#" data-toggle="" data-target="">
                     <div class="list-mig-like-com">
                        <div class="list-mig-lc-img"><img src="https://admin.thelalit.com/getImageByPath.action?imgpath=/opt/thelalit_v1/touradmin/resource/website/website_gallary/gallerysliderbanner14_42.jpg" data-src="https://admin.thelalit.com/getImageByPath.action?imgpath=/opt/thelalit_v1/touradmin/resource/website/website_gallary/gallerysliderbanner14_42.jpg"></div>
                        <div class="list-mig-lc-con">
                           <div class="mt-2 p-2">
                              <div class="row"></div>
                           </div>
               ...
               <div class="col-md-6">
                  <a href="#" data-toggle="" data-target="">
                     <div class="list-mig-like-com">
                        <div class="list-mig-lc-img"><img src="https://admin.thelalit.com/getImageByPath.action?imgpath=/opt/thelalit_v1/touradmin/resource/website/website_gallary/gallerysliderbanner11_69.jpg" data-src="https://admin.thelalit.com/getImageByPath.action?imgpath=/opt/thelalit_v1/touradmin/resource/website/website_gallary/gallerysliderbanner11_69.jpg"></div>
                        <div class="list-mig-lc-con">
                           <div class="mt-2 p-2">
                              <div class="row"></div>
                           </div>
...
<?php
                                } else if ($banner_type == 'Grid1') {
                                ?>
                                    <div class="col-lg-2 col-md-2 col-sm-2 zero-padding">
                                    </div>
                                    <div class="col-lg-8 col-md-8 col-sm-8 zero-padding">
                                        <?php
                                        if ($we_care_post_new_post->have_posts()) :
                                            while ($we_care_post_new_post->have_posts()) : $we_care_post_new_post->the_post();
                                                $count = 1;
                                                ...
                                                if (get_post_status($post->ID) == 'publish') {
                                                    ...
                                                    if ($we_care_type_term_id == $term_id) {
                                                        $we_care_name = get_post_meta($we_care_id, "sub_title", true);
                                                        $we_care_sub_heading = get_post_meta($we_care_id, "sub_heading", true);
                                                        $we_care_footer_title = get_post_meta($we_care_id, "footer_title", true);
                                                        $we_care_main_banner_id = get_post_meta($we_care_id, "main_banner_image", true);
                                        ...
                                        ?>
                                                        <div class="col-lg-12 col-md-12 col-sm-12 zero-padding">
                                                            <div class="card-item js_fade mt101" style="opacity: 1;">
                                                                <?php if ($we_care_main_banner != '') { ?>
                                                                    <img src="<?php echo $we_care_main_banner; ?>">
                                                                <?php } ?>
                                                                <?php if (count($we_care_images) > 0) {
                                                                ?>
                                                                    <div id="slider" class="flexslider slider hidden">
                                                                ...
                                                                ?>
                                                                <?php
                                                                if ($we_care_name != ''  || $we_care_description != '' || $we_care_sub_heading != '' || $we_care_footer_title != '') { ?>
                                                                    <div class="card-info h-product vcard">
                                                                        <div class="row">
                                                                            <div class="lower-content">
                                                                                <?php if ($we_care_name != '') { ?>
                                                                                    <div class="item-title p-name">
                                                                                        <?php echo wpautop($we_care_name); ?>
                                                                                    </div>
                                                                                <?php } ?>
                                                                                <?php if ($we_care_sub_heading != '') { ?>
                                                                                    <div class="card-info-sub">
                                                                                        <?php echo wpautop($we_care_sub_heading); ?>
                                                                                    </div>
                                                                                <?php } ?>
                                                                                <?php if ($we_care_description != '') { ?>
                                                                                ...
                                                                                <?php } ?>
                                                                                <?php if ($we_care_footer_title != '') { ?>
                                                                                    <div class="card-info-footer">
                                                                                        <?php echo wpautop($we_care_footer_title); ?>
                                                                                    </div>
                                                                                <?php } ?>
                                                                            </div>
                                                                        </div>
                                ...
                                ?>
                                    ...
                                    <div class="col-lg-8 col-md-8 col-sm-8 zero-padding">
                                        ...
                                        ?>
                                        <?php if ($countLoop % 2 == 1) { ?> <div class="row"><?php } ?>
                                        <div class="col-md-6">
                  <a href="<?php echo $we_care_permalink; ?>">
                     <div class="list-mig-like-com" data-counter="<?php echo $count; ?>">
               ...
               <?php if ($countLoop % 2 == 0) { ?> </div><?php } ?>
                                        ...
                                        ?>    
                                    <?php } else if ($banner_type == 'Grid-Horizontal') {
                                    ?>
                                        <div class="col-lg-12 col-md-12 col-sm-12 zero-padding">
                                            <?php
                                            if ($we_care_post_new_post->have_posts()) :
                                            ...
                                            ?>
                                                                <div class="col-lg-12 col-md-12 col-sm-12 zero-padding  box-me container-shadow">
                                                                    <div class="col-lg-6 col-md-6 col-sm-6 zero-padding">
                                                                        <div class="js_fade mt101" style="opacity: 1;">
                                                                            <?php
                                                                            if ($we_care_name != ''  || $we_care_description != '' || $we_care_sub_heading != '' || $we_care_footer_title != '') { ?>
                                                                                <div class="card-info h-product vcard">
                                                                                    <div class="row">
                                                                        ...
                                                                        <?php if ($we_care_name != '' || $we_care_description != '') { ?>
                                                                            <div class="card-info h-product vcard">
                                                                                <div class="row">
                                                                                    <div class="lower-content">
                                                                                        <?php if ($we_care_name != '') { ?>
                                                                                            <h6><a class="item-title underline p-name" href="<?php echo $we_care_permalink; ?>"><?php echo $we_care_name; ?></a></h6>
                                                                                        <?php } ?>
                                                                                        <?php if ($we_care_description != '') { ?>
