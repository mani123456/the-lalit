...
$itemList[1]['item']['@id'] = site_url().'/the-lalit-insights/';
$itemList[1]['item']['name'] = 'The Lalit Insights';

$itemList[2]['@type'] = 'ListItem';
$itemList[2]['position'] = $position + 2;
$itemList[2]['item']['@id'] = get_the_permalink(get_the_id());
$itemList[2]['item']['name'] = get_post_meta(get_the_id(), 'insight_title', true);
?>
<!DOCTYPE html>
<html>
    <head>
    ...
    <body <?php body_class('global-page hide-sharing'); ?>>
        <div class="main-wrap">
            <?php get_header(); ?>
                <?php get_template_part( 'detail-pages/insight', 'detail' ); ?>
            <?php get_footer(); ?>
        </div><!-- main-wrap -->
