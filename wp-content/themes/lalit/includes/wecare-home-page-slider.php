...
<?php
$wecare_banners = get_we_care_banners('we_care_list_banner');
?>

<?php
if ($wecare_banners->have_posts()) :

?>
    <div class="container fluid-width section-space clearfix container-shadow" id="popular-dest-6">
        <div class="row clearfix">
            <h2 class="sec-title align-center page-title-home">We Care</h2>
            <div class="owl-carousel owl-theme owl-carousel-care-offers">
                <?php
                $count = 0;
                while ($wecare_banners->have_posts()) : $wecare_banners->the_post();
                                ...
                                ?>
                                    ...
                                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-5 align-right">
                                        ...
                                        <div class="exp-btn-box">
                                            <a href="<?php echo $url; ?>" class="book-now-a noMarginRight" tabindex="0">View</a>
                                        </div>
                                    </div>
                                <?php
                                }
...
<script>
    jQuery(document).ready(function() {
        jQuery(".owl-carousel-care-offers")
            .owlCarousel({
                /* stagePadding: 100, */
                margin: 20,
                autoplay: !1,
