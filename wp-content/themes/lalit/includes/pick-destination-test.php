...
<?php
        ...
        while($destination_obj->have_posts()) : $destination_obj->the_post();
            ...
            //array_push($GLOBALS['hotel_images'],$image);

            $class = rtrim($class, ' ');
?>
                    
                    <li class="colZero col3 hotel"><a href="<?php echo $permalink; ?>" class="hotels-block <?php echo $class; ?>">
                    <?php
                    if($image != '')
                    {
                    ?>
                        <div class="hotel-img-Block hotel-img des-images js_image_load background" data-src="background: url('<?php echo $image; ?>') no-repeat left top;" style=""></div><!-- hotel-img-Block -->
