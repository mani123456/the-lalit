...
?>
    <div class="container fluid-width section-space clearfix container-shadow" id="popular-dest-4">
        <div class="row clearfix">
            ...
            <div class="owl-carousel owl-theme owl-carousel-loy-offers">
                <?php
                $count = 0;
                ...
                ?>
                    ...
                    <div class="card-item card-item-border-radius">
                        <div class="card-img" style="padding:20px;">
                            <a class="hotels-block" href="/the-lalit-loyalty">
                        ...
                        <div class="card-info" style="padding-bottom:0px !important">
                            <div class="row">
                                ...
                                ?>
                                    ...
                                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-5 align-right">
                                        <!-- <a class="pick-restra-btn fancybox" href="#ex_destinations_available<?php echo $count; ?>">Book Now
                                        </a> -->
                                        <div class="exp-btn-box">
                                            <a href="/the-lalit-loyalty" class="book-now-a noMarginRight" tabindex="0">Explore</a>
                                        </div>
                                    </div>
                                <?php
                                }
                            ...
                            <!-- <div class="row">
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 align-left no-padding ">
                                    <div class="exp-btn-box"> <a href="/special-offers/unforgettable-getaways/" class="style1" tabindex="0">Explore</a>
                                        <a href="javascript:;" onclick="openBookingEngine()" class="book-now-a noMarginRight" tabindex="0">Book now</a>
                                    </div>
                                </div>
                            </div> -->
                        </div>
...
<script>
    jQuery(document).ready(function() {
        jQuery(".owl-carousel-loy-offers")
            .owlCarousel({
                /* stagePadding: 100, */
                margin: 20,
                autoplay: !1,
