		...
		<?php if ( $checkout->get_checkout_fields() ) : ?>
			<div class="col col6">
				...
				<div class="form-row place-order">
					...
					?>
					<?php echo apply_filters( 'woocommerce_order_button_html', '<input type="submit" class="button alt checkout-submit" tabindex="'.$tabindex.'" name="woocommerce_checkout_place_order" id="place_order" value="'.$order_button_text.'" data-value="'.$order_button_text.'" />' ); ?>
