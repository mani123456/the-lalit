...
<div class="<?php if(isMobile()) { ?>mob-col mob-col12<?php } else {?>col col6<?php } ?>">
			...
			<p class="form-row form-row-first checkout-username">
				...
				<input type="email" class="input-text checkout-username-input" name="username" id="username" placeholder="Enter your registered email id" autofocus tabindex="1"/>
			</p>
			<p class="form-row form-row-last checkout-password">
				...
				<input class="input-text checkout-password-input" type="password" name="password" id="password" placeholder="Enter your password" tabindex="2"/>
			</p>
			<div class="clear"></div>
			...
			<p class="lost_password checkout-lost-password">
				<a class="checkout-password-link" tabindex="3" href="<?php echo esc_url( wp_lostpassword_url() ); ?>"><?php _e( 'Forgot password?', 'woocommerce' ); ?></a>
			</p>
