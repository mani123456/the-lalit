...
$itemList[1]['item']['@id'] = site_url().'/media-coverage/';
$itemList[1]['item']['name'] = 'Media Coverage';

$itemList[2]['@type'] = 'ListItem';
$itemList[2]['position'] = $position + 2;
$itemList[2]['item']['@id'] = get_the_permalink(get_the_id());
$itemList[2]['item']['name'] = get_post_meta(get_the_id(), 'media_coverage_title', true);
?>
<!DOCTYPE html>
<html>
    <head>
    ...
    <body <?php body_class('global-page hide-sharing'); ?>>
        <div class="main-wrap">
        	<?php get_header(); ?>
                <?php get_template_part( 'detail-pages/media-coverage', 'detail' ); ?>
         	<?php get_footer(); ?>
        </div><!-- main-wrap -->
