...
$body_copy_press_release = wpautop(get_post_meta($post->ID, 'body_copy_press_release', true));
//$publisher_name = get_post_meta($post->ID,'publisher_name',true);

$published_date = get_post_meta($post->ID, 'published_date', true);
$article_or_file = get_post_meta($post->ID, 'article_or_file', true);

$article_or_file = wp_get_attachment_url($article_or_file);

$embed_code = get_post_meta($post->ID, 'video_embed_code', true);
...
//echo $press_release_title."<br> ".$publisher_name.' <br>'.$published_date.'<br> '.$body_copy_press_release;exit;
    ...
    <div class="container fluid-width">
        <div class="row">
            <div class="col col8 align-content-center single-detail">
                <a class="sidebar-head" href="<?php echo site_url(); ?>/press-releases/"> <strong> <i class="ico-sprite sprite size-12 ico-gre-left-arrow"></i> Back to Listing</strong></a>
                <ul class="date-info">
                    <li>Press releases </li>
                    <li><?php echo $published_date; ?></li>
                </ul>
                <h3><?php echo $press_release_title; ?></h3>
                <div class="social-share">
                    <div class="sharethis-inline-share-buttons"></div>
                </div>
                <?php if (trim($body_copy_press_release) != '') {
                    echo $body_copy_press_release;
                } ?>
